...
monitoringService.initiateMetric({metric:metrics.counter, name:"ipWho_user_demographic_tracker", help:"Tracks users Demopraphic", metric_custom_name:"userDemographic[LDOLL]",labelNames:['location','device','os','latitude','longitude']})
